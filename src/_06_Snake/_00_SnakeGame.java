...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "ok so basically im instructions";
	...
	private void setFoodLocation() {
		...
		if(snake.isLocationOnSnake(foodLocation))
		{
			...
			x = y;
			y = tempX;
			Location nL = new Location(x,y);
			foodLocation.equals(nL);
	...
	private void gameOver() {
		...
		JOptionPane.showMessageDialog(null, "You're'e'r'e snake is dead");
		//3. ask them if they want to play again.
		boolean b = false;
		JOptionPane.showInputDialog( b , "Would you like to play again?");
